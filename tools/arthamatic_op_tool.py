...
def currency_converter(from_curr: str, to_curr: str, value: float)->float:
    """
    Convert currency from one currency to another using real-time exchange rates.
    
    Args:
        from_curr (str): The source currency code (e.g., 'USD', 'EUR')
        to_curr (str): The target currency code (e.g., 'EUR', 'GBP')
